...
const DashboardCard = React.forwardRef<EChartsType, ChartCardProps>(({
  ...
  const isControlled = fullscreenOpen !== undefined;
  const open = isControlled ? fullscreenOpen : internalOpen;
  ...
  const childWithHook = React.isValidElement(children)
    ? React.cloneElement<ChartChildProps>(
      children as React.ReactElement<ChartChildProps>,
      {
  ...
  return (
    <React.Fragment>
      <Card
        ...
        sx={{
          borderRadius: 3,
          boxShadow: "0 4px 12px rgba(164, 108, 194, 0.12)",
          p: 2,
          height: "100%",
        }}
      >
                  ...
                  <Tooltip title="Download">
                    <IconButton
                      ...
                      sx={{
                        ...
                        "&:hover": {
                          bgcolor: "rgba(164,108,194,0.15)",
                          color: "rgba(164,108,194,0.85)",
                        },
                      }}
                    >
        ...
        slotProps={{
          backdrop: {
            ...
            sx: {
              ...
              backgroundImage:
                "linear-gradient(120deg, rgba(164,108,194,0.10), rgba(255,255,255,0.45))",
            },
          },
        }}
      >
          ...
          <Zoom in={open}>
            <Box
              sx={{
                ...
                p: 4,
                overflow: "hidden",
                boxShadow: "0 8px 32px rgba(164,108,194,0.28)",
                border: "1px solid rgba(164,108,194,0.18)",
