...
const EmergingThemes: React.FunctionComponent<ChildProps & { data: WordCloudSeriesOption["data"] }> = ({
  data,
  onChartReady
}) => {
  useEffect(() => {
  ...
  return (
    <DashboardCard title="Emerging Themes Accross Investigation">
      <ReactECharts
